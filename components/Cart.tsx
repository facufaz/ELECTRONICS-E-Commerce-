...
const Cart = () => {
  return (
    <Box sx={{position:"absolute",top:120, height:"100vh", width:"100vw", backgroundColor:"rgba(0,0,0,0.7)"}}>
        <Box sx={{position:"absolute",top:20, right:400, minHeight:"20vh", width:"20vw", backgroundColor:"white", padding:"1.5rem"}}>
